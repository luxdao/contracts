    ...
    ERC165
{
     ...
     * @custom:storage-location erc7201:Decent.FreezeVotingStandalone.main
     */
     ...
     * keccak256(abi.encode(uint256(keccak256("Decent.FreezeVotingStandalone.main")) - 1)) & ~bytes32(uint256(0xff))
     */
