    ...
    ERC165
{
     ...
     * keccak256(abi.encode(uint256(keccak256("Decent.ProposerAdapterERC20.main")) - 1)) & ~bytes32(uint256(0xff))
     */
    ...
    /**
     * @inheritdoc ERC165
     * @dev Supports IProposerAdapterERC20V1, IProposerAdapterBaseV1, IVersion, IDeploymentBlockV1, and IERC165
     */
