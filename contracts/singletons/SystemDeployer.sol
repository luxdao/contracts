...
import {ISystemDeployer} from "../interfaces/decent/singletons/ISystemDeployer.sol";
...
contract SystemDeployer is ISystemDeployer {
    // ======================================================================
    // ISystemDeployer
    // ======================================================================
    ...
    function setupSafe(
        ...
        // deploy Azorius Governance contracts
    ...
    function _deployAzoriusGovernance(
        ...
        if (moduleAzoriusV1Params.implementation != address(0)) {
            ...
            // call initialize2 on strategy contract
    ...
    function _deployFreezeContracts(
        ...
        // deploy Freeze Voting contracts
    ...
    function _deployFreezeVoting(
        ...
        // check that only one of the freeze voting contracts is being deployed
